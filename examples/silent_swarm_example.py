...
def main():
    ...
    print("=" * 80)
    print("")
    print("   The comparison worth making is structural, because it can be")
    print("   counted off the design rather than estimated.")
    print("")
    print("   Conversational: every agent both accepts free text and holds a tool.")
    print("   Silent swarm:   one component accepts free text and holds no tool;")
    print("                   the components holding tools accept only typed messages.")
    print("")
    print("   Components that accept free text AND hold a capability:")
    print("      Conversational design: one per agent")
    print("      This design:           0")
    print("")
    print("   That number is the security claim, and it is countable.")
    print("")
    print("   Latency and cost also change, because coordination stops costing")
    print("   generations. By how much depends on how many hops your current")
    print("   design spends on language, and on your unit prices. This run")
    print("   measured neither.")
